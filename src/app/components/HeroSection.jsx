      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            ...
            <Link
              href="/images/DannaAlvarez - CVI.pdf"
        ...
        >
          <div className="sm:border-[#33353F] sm:border bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <Image
              src="/images/skills/profilee.png"
              alt="profile photo"
